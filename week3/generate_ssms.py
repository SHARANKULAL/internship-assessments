...
for table_name in tables:
    ...
    for _, row in df.iterrows():
        ...
        # We don't use INSERT IGNORE in T-SQL, so duplicates will throw an error as expected in DQA raw data
...
print('SSMS SQL script with Primary Keys successfully generated at:', OUT_SQL)
