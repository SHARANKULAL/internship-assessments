...
OUT_SQL = r'C:\Users\shara\OneDrive\Desktop\Aptitude\week3\mysql_raw_data_insert.sql'
...
sql_script = '-- =========================================================================\n'
sql_script += '-- Standard SQL Script to Create Database, Tables and Insert Raw DQA Data\n'
sql_script += '-- =========================================================================\n\n'
...
for table_name in tables:
    ...
    # Insert Statements (Individual Inserts)
    sql_script += f'-- Inserting data into `{table_name}`\n'
    
    insert_header = f'INSERT INTO `{table_name}` (' + ', '.join([f'`{c}`' for c in df.columns]) + ') VALUES '
    ...
    for _, row in df.iterrows():
        ...
        sql_script += insert_header + '(' + ', '.join(vals) + ');\n'
...
print('Standard SQL script successfully generated at:', OUT_SQL)
